...
namespace MatchLeads.Model.DataContracts
{
    class ServiceClient
    {
    ...
    class MMeventDetails
    {
        ...
        public string MatchMakingStartDate { get; set; }
        public string MatchMakingStartTime { get; set; }
        public string MatchMakingEndDate { get; set; }
        public string MatchMakingEndTime { get; set; }
    ...
    public class JSON
    {
        ...
        private void SetKeyValue(ref string data, Dictionary<string, object> dict)
        {
            ...
            try
            {
                ...
                if (val == string.Empty) //value is null
                    dict.Add(key, null);
                ...
                try
                {
                    if (compareVal[0] == '"') //String Arrray
                    {
                        ...
                        for (int valCnt = 0; valCnt < arrayvalues.Count; valCnt++)
                        {
                            ...
                            stringArray.Add(val.Substring(1, val.Length - 2)); //Leaving double quotes in the value and adding
                        }
        ...
        private int GetEndIndex(string data, char open, char close)
        {
            ...
            {
                // Debug.WriteLine("Error occured on JSON CLASS GetEndIndex :" + ex.Message);
                return 0;
            }
        ...
        {
            //Debug.WriteLine("Error occured on JSON CLASS Deserialization");
        }
